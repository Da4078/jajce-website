...
const SLIDES = [
  ...
  { image: Jezera, heading: "Plivska jezera", text: "Veliko i Malo Plivsko jezero, smještena svega pet kilometara od centra Jajca, najveća su prirodna jezera u Bosni i Hercegovini. Posjetiteljima pružaju mirnu oazu netaknute prirode, ali i brojne aktivnosti poput vožnje kajaka, kanua, pecanja ili kupanja.", link: "/discover/lakes"},
