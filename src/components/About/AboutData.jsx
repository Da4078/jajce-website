...
export const aboutPages = {
  ...
  "crkva-sv-marije": {
    heroTitle:"Crkva sv. Marije i toranj sv. Luke",
  ...
  "dzamija-esme-sultanije": {
    heroTitle:"Džamija Esme Sultanije",
  ...
  "omerbegova-kuca": {
    ...
    image: OmerbegovaKuca,
    layout: "image-left"
  },
  "crkva-sv-ivana-krstitelja": {
    heroTitle:"Crkva sv. Ivana Krstitelja",
  ...
  "vikendica": {
    ...
    "brana": {
    heroTitle:"Kupalište Brana",
    title: "Kupalište Brana",
    content: [
      "Kupalište Brana smješteno je uz obale Plivskog jezera, nedaleko od centra Jajca, i predstavlja omiljeno odredište za ljetno rashlađenje i rekreaciju. Ovo prirodno kupalište nudi čiste vode i uređenu obalu koja je pogodna za sve dobne skupine. Posjetitelji mogu uživati u sunčanju na travnatim površinama, kupanju u bistroj vodi jezera ili zabavi na posebno uređenom dječjem igralištu.",
          "Blizina grada čini Kupalište Brana lako dostupnim, a istovremeno pruža osjećaj bijega u prirodu. Okolni šumoviti predjeli nude hladovinu tijekom najtoplijih ljetnih dana, dok obližnji sadržaji omogućavaju sportske aktivnosti poput odbojke na pijesku i piknika. Kupalište Brana idealno je mjesto za obiteljski izlet, druženje s prijateljima ili opuštanje uz zvuke prirode, kombinirajući urbane pogodnosti s ljepotama prirodnog okoliša."  
    ],
    image: Dam,
    layout: "image-left"
  },
