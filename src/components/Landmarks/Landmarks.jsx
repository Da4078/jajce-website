...
const SLIDES = [
  ...
  { image: Katakombe, heading: "Katakombe", text: "Katakombe u Jajcu su podzemna crkva isklesana u stijeni krajem 14. i početkom 15. stoljeća, podignuta po nalogu Hrvoja Vukčića Hrvatinića kao grobnica njegove obitelji. Ovaj jedinstveni spomenik, ukrašen simbolima kulta smrti i vječnog života, posjetiteljima pruža posebno duhovno iskustvo i povratak 600 godina u prošlost.", link: "/discover/katakombe" },
  { image: OmerbegovaKuca, heading: "Omerbegova Kuća", text: "Omerbegova kuća u Jajcu iz 17. stoljeća primjer je bosanske stambene arhitekture iz osmanskog perioda, s kamenom prizemljem, drvenim katom i ukrašenim ulazom. Od 2013. godine služi kao restoran, omogućujući posjetiteljima da uživaju u autentičnom ambijentu i bosanskoj kuhinji.", link: "/discover/omerbegova-kuca" },
  ...
  {image: Dam, heading: "Kupalište rana", text:"Kupalište Brana je mjesto ponosa i ljepote, mjesto koje građani Jajca uvijek nose u svojim srcima i kojem jedva čekaju da se vrate. Dok se drugdje vrijeme provodi u betonu, u Jajcu se uživa uz plavozeleni biser, Branu, i aktivnosti koje su drugima samo pojam.", link: "/discover/brana"}
];
